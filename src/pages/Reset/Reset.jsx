...
const Reset = () => {
  ...
  return (
    <div className="flex relative min-h-screen justify-center items-center w-full">
      <div
        style={{
      ...
      <h2
        onClick={() => navigate(-1)}
        className="text-3xl cursor-pointer absolute top-4 left-4 lg:top-16 lg:left-16 font-medium text-[#24402B]"
      >
        Back
      </h2>
    </div>
