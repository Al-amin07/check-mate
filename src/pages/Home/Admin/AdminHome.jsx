    ...
    <div>
      ...
      <div>
        <div className="flex justify-between lg:w-3/4 my-4 lg:pr-5">
          ...
          <Link
            to={"/tasks"}
            className="col text-lg hover:bg-green-100 px-3 py-1 rounded-md "
          >
            See All
          </Link>
        </div>
        <div className="flex flex-col xl:flex-row  gap-5">
          ...
          <div className=" w-3/4 mx-auto lg:w-64 border p-4 border-green-900 rounded-md flex flex-col h-[350px]">
            ...
            <div className="flex items-center pl-16 gap-1">
              <div className={` bg-[#4F7859]  w-4 h-4 rounded-sm  `}></div>
              Complete
            </div>
            <div className="flex items-center pl-16  gap-1">
              <div className={` bg-[#1D3322] w-4 h-4 rounded-sm  `}></div>
              In Progress
            </div>
            <div className="flex items-center  pl-16 gap-1">
              <div className={` bg-[#2B4C34] w-4 h-4 rounded-sm  `}></div>
              Reject
            </div>
          </div>
        </div>
