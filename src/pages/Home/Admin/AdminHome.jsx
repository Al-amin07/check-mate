...
const AdminHome = () => {
  ...
  if (isLoading) return <div className=" min-h-full flex justify-center items-center">
      ...
      <div>
        ...
        <div className="flex flex-col xl:flex-row  gap-5">
          ...
          <div className=" w-3/4 mx-auto lg:w-64 shadow-2xl rounded-xl flex flex-col h-[350px]">
            <h2 className="text-lg py-[2px] rounded-t-xl text-center mb-4 bg-green-500 text-white ">Tasks Activities</h2>
            <PieChartPlaceholder />
            <div className="flex items-center mt-4 pl-16 gap-1">
