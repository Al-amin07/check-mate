                ...
                <form onSubmit={handleData} className="space-y-3 mt-8">
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <input
                      ...
                      className="w-full border border-[#D1DED4] ml-4 bg-[#f9f9f9] py-1 px-5 rounded-full "
                    />
                  </div>
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <input
                      ...
                      className="w-full border border-[#D1DED4] ml-3 bg-[#f9f9f9] py-1 px-5 rounded-full "
                    />
                  </div>
                  <div className="flex gap-3 items-center">
