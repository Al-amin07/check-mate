        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              ...
              <h2 className="text-[#24402B] font-bold mb-3 text-4xl">Start 7 days Free Trail</h2>
             
                 
<p className="text-xl text-[#24402B] font-semibold">Try first and decide later, no credit card required</p>
