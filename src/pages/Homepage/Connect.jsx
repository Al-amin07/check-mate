    ...
    <div className="relative">
      <div className="container relative z-20  mx-auto px-1 md:px-3 lg:px-6 ">
        ...
        <div className="grid mt-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <img
            src={img5}
            className="h-[300px] sm:h-[350px] hover:scale-95 transition-transform duration-700 object-fill  md:h-[407px] w- w-full"
            alt=""
          />
          <img
            src={img6}
      ...
      {/* <img src={fog} className=" absolute right-0 bottom-0" alt="" /> */}
    </div>
  );
};
