  ...
  return (
    ...
    >
      ...
      <div className="z-10 space-y-6 mb-28">
        <h2 className="text-3xl md:text-4xl lg:text-6xl  leading-[42px] md:leading-[50px] lg:leading-[80px]  text-white md:w-2/3 mx-auto text-center">
        ...
        <button className="px-10 mx-auto flex items-center gap-1 uppercase py-3 font-medium bg-[#22C55E] text-white rounded-lg">Get Started of Free <MdOutlineArrowOutward size={24}/></button>
        </div>
      </div>
      <img className="absolute top-0 right-0 h-[400px]" src={fog} alt="cloud"/>
      <img className="absolute bottom-0 left-0 h-[400px] rounded-b-[80px]" src={fog2} alt="cloud"/>
      <img className=" w-[450px] md:w-[520px]  lg:w-[700px] object-cover absolute -bottom-28 md:-bottom-32 lg:-bottom-[300px]" src={das} alt="" />
